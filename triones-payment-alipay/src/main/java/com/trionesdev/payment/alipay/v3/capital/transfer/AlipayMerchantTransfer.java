package com.trionesdev.payment.alipay.v3.capital.transfer;
...
import com.trionesdev.payment.alipay.v3.capital.AlipayCapital;
...
public class AlipayMerchantTransfer extends AlipayCapital {
     ...
     */
    @SneakyThrows
    public AlipayFundTransUniTransferResponseModel createTransfer(AlipayMerchantTransferRequest request) {
